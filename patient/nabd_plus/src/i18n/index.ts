...
export const autoTranslations: Record<string, Record<LangCode, string>> = {
  ...
  "أكملي ملف متابعة الحمل": { ar: "أكملي ملف متابعة الحمل", en: "Complete your pregnancy profile", ur: "اپنا حمل پروفائل مکمل کریں", hi: "अपनी गर्भावस्था प्रोफ़ाइल पूरी करें", bn: "আপনার গর্ভাবস্থা প্রোফাইল সম্পূর্ণ করুন", fil: "Kumpletuhin ang iyong profile sa pagbubuntis" },
  "سنعرِض أسبوع الحمل الصحيح والمرئيات التعليمية بعد حفظ تاريخ آخر دورة أو موعد الولادة المتوقع.": { ar: "سنعرِض أسبوع الحمل الصحيح والمرئيات التعليمية بعد حفظ تاريخ آخر دورة أو موعد الولادة المتوقع.", en: "We will show your correct pregnancy week and educational visuals after you save your last period date or estimated due date.", ur: "آخری ماہواری کی تاریخ یا متوقع تاریخِ پیدائش محفوظ کرنے کے بعد ہم حمل کا درست ہفتہ اور تعلیمی تصاویر دکھائیں گے۔", hi: "अंतिम माहवारी की तारीख या अनुमानित प्रसव तिथि सहेजने के बाद हम गर्भावस्था का सही सप्ताह और शैक्षिक दृश्य दिखाएंगे।", bn: "শেষ মাসিকের তারিখ বা সম্ভাব্য প্রসবের তারিখ সংরক্ষণ করার পর আমরা সঠিক গর্ভকাল এবং শিক্ষামূলক ভিজ্যুয়াল দেখাব।", fil: "Ipapakita namin ang tamang linggo ng pagbubuntis at mga educational visual pagkatapos mong i-save ang huling regla o inaasahang petsa ng panganganak." },
  "إعداد متابعة الحمل": { ar: "إعداد متابعة الحمل", en: "Set up pregnancy tracking", ur: "حمل کی نگرانی ترتیب دیں", hi: "गर्भावस्था ट्रैकिंग सेट करें", bn: "গর্ভাবস্থা ট্র্যাকিং সেট আপ করুন", fil: "I-set up ang pagsubaybay sa pagbubuntis" },
  "مجسم تفاعلي": { ar: "مجسم تفاعلي", en: "Interactive 3D model", ur: "انٹرایکٹو 3D ماڈل", hi: "इंटरैक्टिव 3D मॉडल", bn: "ইন্টারঅ্যাকটিভ 3D মডেল", fil: "Interactive na 3D model" },
  "عرض الصورة": { ar: "عرض الصورة", en: "View image", ur: "تصویر دکھائیں", hi: "चित्र देखें", bn: "ছবি দেখুন", fil: "Tingnan ang larawan" },
  "العودة إلى أسبوعك الحالي": { ar: "العودة إلى أسبوعك الحالي", en: "Return to your current week", ur: "اپنے موجودہ ہفتے پر واپس جائیں", hi: "अपने वर्तमान सप्ताह पर लौटें", bn: "আপনার বর্তমান সপ্তাহে ফিরুন", fil: "Bumalik sa kasalukuyan mong linggo" },
  "اسحبي لتدوير المجسم واضغطي على الجزء التعليمي": { ar: "اسحبي لتدوير المجسم واضغطي على الجزء التعليمي", en: "Drag to rotate the model and tap an educational part", ur: "ماڈل گھمانے کے لیے ڈریگ کریں اور تعلیمی حصے پر ٹیپ کریں", hi: "मॉडल घुमाने के लिए खींचें और शैक्षिक भाग पर टैप करें", bn: "মডেল ঘোরাতে টানুন এবং শিক্ষামূলক অংশে ট্যাপ করুন", fil: "I-drag para iikot ang modelo at i-tap ang bahaging pang-edukasyon" },
  "يمكنك تكبير وتصغير الصورة": { ar: "يمكنك تكبير وتصغير الصورة", en: "You can zoom in and out of the image", ur: "آپ تصویر کو زوم ان اور آؤٹ کر سکتے ہیں", hi: "आप चित्र को ज़ूम इन और आउट कर सकते हैं", bn: "আপনি ছবিটি জুম ইন ও আউট করতে পারেন", fil: "Maaari mong i-zoom in at out ang larawan" },
  "المرئيات والنموذج للتعليم العام فقط، ولا يمثلان فحصاً أو قياساً أو حالة حمل فردية.": { ar: "المرئيات والنموذج للتعليم العام فقط، ولا يمثلان فحصاً أو قياساً أو حالة حمل فردية.", en: "The visuals and model are for general education only; they are not an examination, measurement, or an individual pregnancy assessment.", ur: "تصاویر اور ماڈل صرف عمومی تعلیم کے لیے ہیں؛ یہ معائنہ، پیمائش یا انفرادی حمل کا جائزہ نہیں ہیں۔", hi: "दृश्य और मॉडल केवल सामान्य शिक्षा के लिए हैं; ये जांच, माप या व्यक्तिगत गर्भावस्था मूल्यांकन नहीं हैं।", bn: "ভিজ্যুয়াল এবং মডেল কেবল সাধারণ শিক্ষার জন্য; এগুলো পরীক্ষা, পরিমাপ বা ব্যক্তিগত গর্ভাবস্থা মূল্যায়ন নয়।", fil: "Ang mga visual at modelo ay para lamang sa pangkalahatang edukasyon; hindi ito pagsusuri, pagsukat, o indibidwal na pagtatasa ng pagbubuntis." },
  "توجيه الرعاية": { ar: "توجيه الرعاية", en: "Care guidance", ur: "نگہداشت کی رہنمائی", hi: "देखभाल मार्गदर्शन", bn: "যত্ন নির্দেশনা", fil: "Gabay sa pangangalaga" },
  "الخطوة التالية الآمنة": { ar: "الخطوة التالية الآمنة", en: "Safe next step", ur: "اگلا محفوظ قدم", hi: "सुरक्षित अगला कदम", bn: "নিরাপদ পরবর্তী পদক্ষেপ", fil: "Ligtas na susunod na hakbang" },
  "لا تُستخدم النتيجة لتشخيص الحالة أو لاستبدال التقييم الطبي": { ar: "لا تُستخدم النتيجة لتشخيص الحالة أو لاستبدال التقييم الطبي", en: "The result is not used to diagnose a condition or replace medical assessment", ur: "نتیجہ تشخیص یا طبی معائنے کے متبادل کے لیے استعمال نہیں ہوتا", hi: "परिणाम का उपयोग निदान या चिकित्सा मूल्यांकन के स्थान पर नहीं किया जाता", bn: "ফলাফল রোগ নির্ণয় বা চিকিৎসা মূল্যায়নের বিকল্প হিসেবে ব্যবহার করা হয় না", fil: "Ang resulta ay hindi ginagamit upang mag-diagnose o pumalit sa medikal na pagsusuri" },
};
