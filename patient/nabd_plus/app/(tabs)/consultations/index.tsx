            ...
            <ScrollView showsVerticalScrollIndicator={false}>
              {stepIns === 1 ? (
                Object.keys(saudiInsurances).map(comp => (
                  ...
                  >
                    <LocalizedText style={{ fontSize: 15, fontWeight: '800', textAlign: 'center', color: insCompany === comp ? '#fff' : colors.n }}>{comp}</LocalizedText>
                  </TouchableOpacity>
                ))
              ) : (
                saudiInsurances[insCompany as keyof typeof saudiInsurances]?.map((cls: string) => (
                  ...
                  >
                    <LocalizedText style={{ fontSize: 15, fontWeight: '800', textAlign: 'center', color: insClass === cls ? '#fff' : colors.n }}>{cls}</LocalizedText>
                  </TouchableOpacity>
                ))
              )}
            </ScrollView>
