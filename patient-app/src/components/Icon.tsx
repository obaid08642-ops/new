...
const FIXES: Record<string, string> = {
  ...
  call: 'phone',
  otp: 'shield-key',
  index: 'format-list-numbered',
  health: 'heart-pulse',
  attach: 'paperclip',
  userAdd: 'account-plus',
  eyeOff: 'eye-off',
  bloodtype: 'water',
  locationFilled: 'map-marker',
