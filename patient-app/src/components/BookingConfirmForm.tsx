...
import { AppText, Card, Button, IconButton, SegmentedControl, SectionHeader } from '../components/ui';
...
export default function BookingConfirmScreen() {
  ...
  const handleConfirm = async () => {
    ...
    try {
      ...
      router.replace({ pathname: '/consultations/booking-status', params: { appointmentId: appointment.id, visitType, payment_pending: payMethod === 'card' ? 'true' : 'false' } });
    } catch (error: any) {
