...
export const BASE_URL = 'https://api.nabdahplus.com/api/v1';
export const FASTAPI_BASE_URL = 'https://ai.nabdahplus.com';
export const CDN_URL = 'https://cdn.nabdahplus.com';
