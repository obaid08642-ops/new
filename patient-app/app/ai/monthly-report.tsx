// A monthly health report must originate from a verified server-side clinical aggregation contract.
    ...
    <View style={[styles.container, { backgroundColor: colors.background, paddingTop: insets.top + 16 }]}>
      ...
      <View style={styles.content}>
        <View style={[styles.iconCircle, { backgroundColor: colors.primarySurface }]}>
          <Icon name="insights" size={38} color={colors.primary} />
        </View>
        <AppText variant="h4" align="center">التقرير الشهري غير متاح حالياً</AppText>
        <AppText variant="bodySM" color={colors.textSecondary} align="center">
          لن يعرض التطبيق درجات صحية أو تحليلاً أو مواعيد أو توصيات محلية. يلزم عقد خادمي موثق يجمع البيانات السريرية والأنشطة الفعلية قبل التفعيل.
        </AppText>
