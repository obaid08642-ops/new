                ...
                {lastPeriod && (
                  <View style={styles.selectedIndicator}>
                    ...
                    <AppText variant="bodySM" color="#5BA84F" style={{ fontWeight: '800' }}>
                      تم اختيار: {lastPeriod.toLocaleDateString('ar-SA', { day: 'numeric', month: 'long', year: 'numeric' })}
                    </AppText>
                  </View>
                )}
              </View>
              ...
              <View style={styles.inputContainer}>
                ...
                {prevPeriod && (
                  <View style={styles.selectedIndicator}>
                    <Icon name="check_circle" size={18} color="#5BA84F" />
                    <AppText variant="bodySM" color="#5BA84F" style={{ fontWeight: '800' }}>
                      تم اختيار: {prevPeriod.toLocaleDateString('ar-SA', { day: 'numeric', month: 'long', year: 'numeric' })}
                    </AppText>
                  </View>
                )}
                {!prevPeriod && (
