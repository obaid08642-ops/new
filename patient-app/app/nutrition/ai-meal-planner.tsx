...
export default function AIMealPlannerScreen() {
  ...
  const dayTotal = dayMeals.reduce((s: number, m: any) => s + m.cals, 0);
      ...
      <View style={[styles.container, { backgroundColor: colors.background } ]}>
        ...
        <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={{ paddingBottom: 100 }}>
          ...
          <View style={styles.actions}>
            <TouchableOpacity style={[styles.exportBtn, { borderColor: colors.border } ]}>
              <Icon name="share" size={16} color={colors.primary} />
              <AppText variant="bodySM">مشاركة الخطة</AppText>
            </TouchableOpacity>
            <TouchableOpacity style={[styles.exportBtn, { borderColor: colors.border } ]}>
              <Icon name="download" size={16} color={colors.secondary} />
              <AppText variant="bodySM">تحميل PDF</AppText>
            </TouchableOpacity>
          </View>
        </ScrollView>
      </View>
