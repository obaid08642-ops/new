...
## P7 — الباكند العميق [🔄 جارية]
- ✅ الرانكنج: مثبت مربوط end-to-end (R32-48 → PASS بملاحظات)
- ✅ صدق MCP: بوابات أهلية + إزالة كل التلفيق (أسعار/مواعيد/فروع) — `b40136bb`
- ⬜ المتبقي P7: توحيد الأخطاء + مراجعة نهائية + بوابة
