...
import { View, StyleSheet, ScrollView, TouchableOpacity, StatusBar, ActivityIndicator, Dimensions, Alert } from 'react-native';
...
export default function MaternityHubScreen() {
  ...
  const dueDateStr = dueDate.toLocaleDateString(dateLocale(), { day: 'numeric', month: 'long', year: 'numeric' });
