  ...
  return (
    <div className="p-8 h-full flex flex-col">
      <div className="mb-6 flex justify-between items-center border-b border-gray-200 pb-4">
        ...
        <div className="bg-slate-50 border border-slate-200 text-slate-600 px-4 py-2 rounded-lg text-sm flex items-center gap-2 shadow-sm" title="سجل المراقبة للقراءة فقط — الإجراءات تتم من شاشات الإدارة المختصة">
