...
- [ ] Phase 8 remediation batch A — public care discovery: enforce active/published status for provider/facility detail and slots, introduce minimum-data public DTO/projections, remove inactive similar records, apply safe bounded search input, return truthful pagination, and add focused backend tests before any UI restyling.
