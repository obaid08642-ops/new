...
- [ ] Replace Patient Mobile consultation booking-pending polling, elapsed timeout, automatic navigation, and non-idempotent cancellation with an explicit server-status refresh and idempotent cancellation only.
