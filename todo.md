...
- [ ] Add Patient Mobile per-item insurance decision presentation and explicit co-pay or self-pay acceptance from server capabilities; render fully covered insurance without a payment action.
