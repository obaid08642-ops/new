...
- [ ] Phase 8 remediation batch J — medication reminder fidelity: preserve exact dose/form/route and supported recurrence semantics end to end; prevent monthly-to-weekly coercion; require canonical server persistence before confirmation; and add focused recurrence/precision regressions before reminder UI polish.
