...
// ─── Insurance Companies ──────────────────────────────────────────────────────
// ─── Spoken Languages (provider onboarding — all types) ─────────────────────
export const LANGS = [
 { id:'ar', ar:'العربية', en:'Arabic' },
 { id:'en', ar:'الإنجليزية', en:'English' },
 { id:'ur', ar:'الأردية', en:'Urdu' },
 { id:'hi', ar:'الهندية', en:'Hindi' },
 { id:'tl', ar:'الفلبينية', en:'Filipino' },
 { id:'bn', ar:'البنغالية', en:'Bengali' },
...
export const PHARMA_CATS = [
 ...
 { id:'eye', ar:'العناية بالعيون', en:'Eye Care', icon:'' },
 { id:'ortho', ar:'دعامات ومستلزمات عظام', en:'Orthopedic Supplies', icon:'bone' },
...
// Default to the production API so the app works out-of-the-box on any device.
// Local backend development: set EXPO_PUBLIC_API_URL in .env (e.g. http://192.168.1.10:8002)
// or leave it empty and rely on LOCAL_DEV_API=1 to use the Metro host IP / emulator loopback.
...
export const API_BASE = envApiUrl
  ...
  : process.env.EXPO_PUBLIC_LOCAL_DEV === '1'
    ? `http://${localIp}:8002/api/v1`
