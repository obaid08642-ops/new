...
const PATHS: Record<string, string[]> = {
 ...
 // ─── Added for the zero-emoji purge (replacements for legacy emoji glyphs) ───
 eyeOff: ['M9.88 9.88a3 3 0 104.24 4.24','M6.61 6.61C4.16 8.06 2.36 10.44 1 12c1.73 2.44 4.94 6 11 6 1.9 0 3.65-.46 5.13-1.13','M10.73 5.08A10.7 10.7 0 0112 5c6.06 0 9.27 3.56 11 6-.6 1.08-1.5 2.28-2.72 3.37','M2 2l20 20'],
 alert: ['M12 9v4','M12 17h.01','M10.29 3.86L1.82 18a2 2 0 001.71 3h16.94a2 2 0 001.71-3L13.71 3.86a2 2 0 00-3.42 0z'],
 robot: ['M12 8V4H8','M4 8h16a2 2 0 012 2v8a2 2 0 01-2 2H4a2 2 0 01-2-2v-8a2 2 0 012-2z','M8 14h.01','M16 14h.01','M9 18h6'],
 hourglass: ['M6 2h12','M6 22h12','M8 2v4l4 4 4-4V2','M8 22v-4l4-4 4 4v4'],
 pregnancy: ['M12 21c4.97 0 9-4.03 9-9 0-3.31-2.69-6-6-6-2.21 0-4 1.79-4 4 0 1.5.83 2.61 2 3.5V21','M9 3C7 3 5.5 4.5 5.5 6.5S7 10 9 10'],
 wrench: ['M14.7 6.3a4.5 4.5 0 00-6 6L3 18l3 3 5.7-5.7a4.5 4.5 0 006-6L14 13l-3-3 3.7-3.7z'],
 xRay: ['M4 3h16a1 1 0 011 1v16a1 1 0 01-1 1H4a1 1 0 01-1-1V4a1 1 0 011-1z','M8 7h.01','M16 7h.01','M8 17h.01','M16 17h.01','M12 9v6','M9 12h6'],
 receipt: ['M4 2h16v20l-2-1-2 1-2-1-2 1-2-1-2 1-2-1-2 1z','M8 7h8','M8 11h8','M8 15h5'],
 baby: ['M12 8a3.5 3.5 0 100-7 3.5 3.5 0 000 7z','M12 12c-4 0-7 2.5-7 6 0 2 1.5 3 3.5 3h7c2 0 3.5-1 3.5-3 0-3.5-3-6-7-6z','M9.5 15h.01','M14.5 15h.01'],
 smartphone: ['M7 2h10a2 2 0 012 2v16a2 2 0 01-2 2H7a2 2 0 01-2-2V4a2 2 0 012-2z','M12 18h.01'],
 play: ['M6 4l14 8-14 8z'],
 stop: ['M6 6h12v12H6z'],
 trash: ['M3 6h18','M8 6V4a2 2 0 012-2h4a2 2 0 012 2v2','M19 6l-1 14a2 2 0 01-2 2H8a2 2 0 01-2-2L5 6','M10 11v6','M14 11v6'],
 lungs: ['M12 4v8','M12 12c-1-2-3-4-5-4-2.5 0-4 3-4 7 0 3 1 5 3 5 1.5 0 2-1 2-2.5V12','M12 12c1-2 3-4 5-4 2.5 0 4 3 4 7 0 3-1 5-3 5-1.5 0-2-1-2-2.5V12'],
 // ─── Aliases & previously-missing names (were rendering as empty boxes) ────
 add: ['M12 5v14','M5 12h14'],
 addPhotoAlternate: ['M19 3H5a2 2 0 00-2 2v14a2 2 0 002 2h14a2 2 0 002-2V5a2 2 0 00-2-2z','M8.5 10a1.5 1.5 0 100-3 1.5 1.5 0 000 3z','M21 15l-5-5L5 21','M12 5v6','M9 8h6'],
 'camera-outline': ['M23 19a2 2 0 01-2 2H3a2 2 0 01-2-2V8a2 2 0 012-2h4l2-3h6l2 3h4a2 2 0 012 2z','M12 17a4 4 0 100-8 4 4 0 000 8z'],
 chevronRight: ['M9 18l6-6-6-6'],
 event: ['M19 4H5a2 2 0 00-2 2v14a2 2 0 002 2h14a2 2 0 002-2V6a2 2 0 00-2-2z','M16 2v4','M8 2v4','M3 10h18'],
 ...
 payments: ['M21 18V6a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2h14a2 2 0 002-2z','M3 10h18','M7 15h4'],
 person: ['M20 21v-2a4 4 0 00-4-4H8a4 4 0 00-4 4v2','M12 11a4 4 0 100-8 4 4 0 000 8z'],
 'phone-off': ['M10.68 13.31a16 16 0 003.41 2.6l1.27-1.27a2 2 0 012.11-.45 12.84 12.84 0 002.81.7 2 2 0 011.72 2v3a2 2 0 01-2.18 2 19.79 19.79 0 01-8.63-3.07','M4.73 4.18A19.79 19.79 0 002.11 4.2 2 2 0 004.1 6.38v-3a2 2 0 012-1.72 12.84 12.84 0 00.7 2.81 2 2 0 01-.45 2.11L5.09 7.85','M23 1l-22 22'],
 profile: ['M20 21v-2a4 4 0 00-4-4H8a4 4 0 00-4 4v2','M12 11a4 4 0 100-8 4 4 0 000 8z'],
 'qr-code-scanner': ['M3 7V5a2 2 0 012-2h2','M17 3h2a2 2 0 012 2v2','M21 17v2a2 2 0 01-2 2h-2','M7 21H5a2 2 0 01-2-2v-2','M7 7h4v4H7z','M13 7h4v4h-4z','M7 13h4v4H7z','M13 13h4v4h-4z'],
 radar: ['M12 12m-1 0a1 1 0 102 0 1 1 0 10-2 0','M12 12m-5 0a5 5 0 105.5 4.97','M12 12m-9 0a9 9 0 109.5 8.97','M12 12l7-7'],
 ...
 timer: ['M12 22c5.523 0 10-4.477 10-10S17.523 2 12 2 2 6.477 2 12s4.477 10 10 10z','M12 6v6l4 2','M9 2h6'],
 trendingUp: ['M23 6l-9.5 9.5-5-5L1 18','M17 6h6v6'],
 'user-check': ['M16 21v-2a4 4 0 00-4-4H5a4 4 0 00-4 4v2','M8.5 11a4 4 0 100-8 4 4 0 000 8z','M17 8l2 2 4-4'],
 'user-x': ['M16 21v-2a4 4 0 00-4-4H5a4 4 0 00-4 4v2','M8.5 11a4 4 0 100-8 4 4 0 000 8z','M18 8l5 5','M23 8l-5 5'],
 verified: ['M12 2l2.4 2.4 3.3-.5.9 3.2 3 1.5-1.1 3.1 1.1 3.1-3 1.5-.9 3.2-3.3-.5L12 22l-2.4-2.4-3.3.5-.9-3.2-3-1.5 1.1-3.1-1.1-3.1 3-1.5.9-3.2 3.3.5z','M9 12l2 2 4-4'],
 'video-off': ['M16 16v1a2 2 0 01-2 2H3a2 2 0 01-2-2V7a2 2 0 012-2h2','M10.66 6H14a2 2 0 012 2v2.34l1 1L23 7v10','M1 1l22 22'],
...
export function I({ name, size = 22, color, strokeWidth = 1.8, style }: IconProps) {
...
/** True when `name` resolves to a real vector icon (used to upgrade legacy
 *  text-rendered icon props to SVG without breaking unknown/legacy values). */
