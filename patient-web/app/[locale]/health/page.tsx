...
import { Activity, Bell, CalendarDays, FileBarChart, FileText, HeartPulse, MessageCircle, Moon, Pill, UsersRound } from "lucide-react";
...
const quickActions = [
  ...
  { key: "monthlyReport", href: "health/monthly-report", icon: FileBarChart, color: "#7C3AED" },
  { key: "vitalsHistory", href: "health/vitals", icon: HeartPulse, color: "#0EA5E9" },
] as const;
const quickLabels: Record<string, Record<string, string>> = {
  ar: { prescriptions: "وصفاتي", family: "العائلة", reminders: "تذكيراتي", chat: "محادثة", sleep: "النوم", chronicDiseases: "الحالات المزمنة", chronicMedications: "الأدوية المزمنة", trends: "الاتجاهات", monthlyReport: "التقرير الشهري", vitalsHistory: "سجل المؤشرات" },
  en: { prescriptions: "Prescriptions", family: "Family", reminders: "Reminders", chat: "Chat", sleep: "Sleep", chronicDiseases: "Chronic conditions", chronicMedications: "Chronic medicines", trends: "Trends", monthlyReport: "Monthly report", vitalsHistory: "Vitals history" },
  ur: { prescriptions: "نسخے", family: "خاندان", reminders: "یاددہانیاں", chat: "گفتگو", sleep: "نیند", chronicDiseases: "دائمی حالتیں", chronicMedications: "دائمی ادویات", trends: "رجحانات", monthlyReport: "ماہانہ رپورٹ", vitalsHistory: "Vitals history" },
  hi: { prescriptions: "प्रिस्क्रिप्शन", family: "परिवार", reminders: "अनुस्मारक", chat: "चैट", sleep: "नींद", chronicDiseases: "दीर्घकालिक स्थितियाँ", chronicMedications: "दीर्घकालिक दवाएँ", trends: "रुझान", monthlyReport: "मासिक रिपोर्ट", vitalsHistory: "Vitals history" },
  bn: { prescriptions: "প্রেসক্রিপশন", family: "পরিবার", reminders: "রিমাইন্ডার", chat: "চ্যাট", sleep: "ঘুম", chronicDiseases: "দীর্ঘমেয়াদি অবস্থা", chronicMedications: "দীর্ঘমেয়াদি ওষুধ", trends: "প্রবণতা", monthlyReport: "মাসিক রিপোর্ট", vitalsHistory: "Vitals history" },
  fil: { prescriptions: "Reseta", family: "Pamilya", reminders: "Paalala", chat: "Chat", sleep: "Tulog", chronicDiseases: "Chronic conditions", chronicMedications: "Chronic medicines", trends: "Trends", monthlyReport: "Monthly report", vitalsHistory: "Vitals history" },
};
