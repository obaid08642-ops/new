...
import { extractMedicationReminderSummaries, type MedicationReminderSummary } from "@/lib/api/reminders";
...
export default async function RemindersPage({ params }: Props) {
  ...
  let reminders: MedicationReminderSummary[] = [];
  try {
