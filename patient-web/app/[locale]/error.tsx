...
export default function LocaleError({ reset }: { error: Error & { digest?: string }; reset: () => void }) {
  ...
  return (
    <main className="main auth-wrap" style={{ background: "#FDFDFC", padding: "32px 16px" }}>
      <section className="auth-card" role="alert" aria-live="assertive" style={{ background: "rgba(255,255,255,.82)", backdropFilter: "blur(16px)", WebkitBackdropFilter: "blur(16px)", border: "1px solid #E8EDEE", borderRadius: 20, padding: 32, maxWidth: 480, margin: "0 auto", display: "grid", gap: 16 }}>
        <span aria-hidden style={{ width: 48, height: 48, borderRadius: 14, display: "grid", placeItems: "center", background: "rgba(255,77,90,.12)", color: "#FF4D5A" }}>
