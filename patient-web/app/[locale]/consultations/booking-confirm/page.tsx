...
/** Parity with app booking-confirm: deprecated in-app, merged into booking-status. */
export default async function ConsultationBookingConfirmPage({ params, searchParams }: Props) {
