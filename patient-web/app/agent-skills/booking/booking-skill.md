# Nabd Plus Healthcare Booking Skill (Agent Skill)
...
- **Strict Idempotency**: All booking requests must provide an `idempotency_key` (UUID v4) to eliminate double-booking risks.
