...
| P1 | 64 | Material correctness, security, parity, truthfulness or lifecycle gaps. |
| P2 | 6 | Important product/parity or governance gaps; may be scheduled only after launch scope decision. |
| Total | 74 | Confirmed source findings recorded to date. |

## Confirmed findings

The authoritative detailed register is `confirmed-findings-v1.md`; it contains F-001 through F-074 with direct file/line evidence and acceptance conditions. The findings are grouped below for reviewer triage.
