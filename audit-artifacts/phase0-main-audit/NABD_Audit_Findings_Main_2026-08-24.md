...
| P1 | 29 | Material correctness, security, parity, truthfulness or lifecycle gaps. |
| P2 | 5 | Important product/parity or governance gaps; may be scheduled only after launch scope decision. |
| Total | 37 | Confirmed source findings recorded to date. |

## Confirmed findings

The authoritative detailed register is `confirmed-findings-v1.md`; it contains F-001 through F-038 with direct file/line evidence and acceptance conditions. The findings are grouped below for reviewer triage.
...
| F-028, F-029, F-030, F-031, F-032, F-035, F-036, F-037, F-038 | Patient parity | Web is read-only while Mobile exposes security/privacy/notification/profile/address/health actions with incomplete contract, guest policy, delivery and failure semantics. |
