...
| 2. Pharmacy / medicine / cart / orders | `/medicines`, categories, search/filter, product add/qty, barcode, prescription scan, local cart, checkout/payment/order tracking | public medicine catalog, medicine detail, authenticated read-only `/cart` and checkout preview, order list/detail/tracking | Mobile checkout/payment/tracking/orders evidence; Web cart/checkout evidence; backend pharmacy/order/payment routes require exact reconciliation | catalog unavailable/empty, stale cache, prescription required, stock/price change, split order, delivery, cash/card/wallet/insurance, cancel/refund, stale tracking | session/cart isolation, PHI prescription protection, server price/stock/payment state, owner order access | cart/order/payment idempotency/replay, insurance approval, amount mismatch, owner/stranger/unauth | PARTIAL / FINDING |
...
| 5. Health / prescriptions / insurance / family | Health/vitals, prescriptions, insurance add/update, family invite/scan/join/chat/permissions/member health and orders actions | Read-only health/prescription/profile/family/insurance surfaces audited partially | Mobile insurance/family invite/join/scan/permission/chat evidence; Web read helpers and backend modules need DTO/ownership/test reconciliation | loading, empty, unavailable, stale, consent, expired/used/revoked invite, permission request, claim/preauth decisions | PHI minimization, delegated family access, owner/stranger 404, audience binding | vital/reminder mutation contracts, prescription upload/renewal, insurance eligibility/claim replay, family consent/revoke/audit | PARTIAL / FINDING |
