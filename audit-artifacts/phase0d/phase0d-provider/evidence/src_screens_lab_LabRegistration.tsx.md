...
- **Member path:** `src/screens/lab/LabRegistration.tsx`
- **Member SHA-256:** `57b60ff59e885e842e71cb7de47bb6d50412c24da23c3510ed03d8e92461b4bb`
- **Line count:** 1858
- **Read range:** `1-1858`
...
- `344: // Custom validation for Lab/Radiology separation`
- `490: hint={AR ? 'ترخيص المعمل/مركز الأشعة من MOH' : 'Lab/Radiology license from MOH'} />`
### auth_ownership
...
- `119: const [data, setData] = useState<LabRegData>({ ...INIT, centerType: providerType });`
