...
**مرشح Backend الأحدث غير المنشور:** `8124e1de22fc3eb23307f2f67d528613f3299c76`، ويضم مسار الوصفات اليدوية وإصلاح Hospital RBAC وإصلاح auto-confirm للاستشارة النقدية وإصلاح تقرير المختبر المخبأ.
...
| نشر مرشح الوصفات اليدوية وBOLA للمسارات المعدِّلة وإصلاح Hospital RBAC وauto-confirm للاستشارة النقدية وتقرير المختبر المخبأ | Reviewer/DevOps | BLOCKED | لا يوجد تفويض نشر منفصل للمرشح `8124e1d`؛ لا يختبر عقده الجديد حياً قبل النشر |
