...
- الفجوات الحقيقية ≈ 6 مجموعات (بعد video-call) (بعد wallet) (بعد الإغلاق اليدوي الثاني) (بعد إغلاق صفحات حالات الحجز) (وليست 103) — أغلبها: حالات ما بعد الحجز، مكالمة الفيديو، تتبع العينات، عروض الصيدلية المرئية، والمحفظة/الإعدادات.
...
- الفجوات الحقيقية ≈ 6 مجموعات (بعد video-call) (بعد wallet) فقط، أعلاها: مكالمة فيديو Web، انتظار broadcast الصيدلية والعروض التراكمية، وتتبع العينات.
