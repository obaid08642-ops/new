...
- 8.2 ✅ أنيميشن دخول عالمي لكل شاشات الموبايل عبر screenOptions في root Stack (fade_from_bottom 250ms) — أو مكوّن الغلاف حيث لا ينطبق.
...
- 8.5 ⏳ شاشات الويب الناقصة المتبقية من قائمة 4.5 (المجموعات المؤجلة بعقود) — تُبنى عند تأكيد عقودها.
