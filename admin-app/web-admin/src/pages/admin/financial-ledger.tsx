...
export default function FinancialLedger() {
  ...
  const calculateNet = (base: number, type: string) => {
    ...
    const vatOnCommission = systemCommission * 0.15; // VAT 15% applied strictly to NABDah Commission
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div className="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden">
              ...
              <div className="p-4 bg-gray-50 border-t border-gray-200 text-xs text-gray-500 font-mono">
                Provider Earning = (Base Bill - System Commission) + VAT 15% applied strictly to NABDah Commission
              </div>
            </div>
