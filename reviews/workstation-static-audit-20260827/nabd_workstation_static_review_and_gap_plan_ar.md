...
| سلامة كائنات Git | `git fsck --full` لم يبلغ عن فساد في التاريخ القابل للوصول، لكنه أظهر commit معزولاً واحداً `89a6e9c…`. | لا يُنسب هذا الكائن المعزول إلى العمل المعروض قبل تفسير provenance له. |
