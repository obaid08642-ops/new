...
export default async function AppointmentDetailPage({ params }: Props) {
  ...
  if (!appointment) return <main className="main dashboard"><section className="status-card" role="alert"><h1>{t("unavailableTitle")}</h1><p>{t("unavailableBody")}</p><RetryButton /></section></main>;
