...
export const DEEP_LINK_CONFIG: { screens: DeepLinkScreens } = {
  screens: {
    ...
    'consultations/booking-confirm': 'booking/:doctorId',
    'consultations/booking-success': 'booking-success/:id',
    ...
    'pharmacy/drug-not-found': 'pharmacy/request-drug',
    'pharmacy/custom-item': 'pharmacy/custom',
