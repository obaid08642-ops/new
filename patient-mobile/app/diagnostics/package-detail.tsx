  ...
  return (
    <SafeAreaView style={[styles.safeArea, { backgroundColor: colors.background } ]}>
      ...
      <Animated.View entering={SlideInDown.duration(400)} style={[styles.floatingBottom, { backgroundColor: colors.surface, borderTopColor: colors.border } ]}>
        ...
        <TouchableOpacity
          style={[styles.addBtn, { backgroundColor: 'transparent', borderColor: colors.primary, marginBottom: 10 }]}
          onPress={() => router.push({ pathname: '/diagnostics/book', params: { kind: 'lab', packageId: id } })}
        >
          <Icon name="event-available" size={22} color={colors.primary} />
          <AppText style={{ color: colors.primary, fontSize: 16, fontWeight: 'bold' }}>
            احجز الآن (مواعيد فورية)
          </AppText>
        </TouchableOpacity>
