...
// F-H: root crash boundary — previously exported but never mounted, so render
// crashes bypassed structured handling/Sentry UX.
import { AppErrorBoundary } from '../src/services/ErrorHandler';
