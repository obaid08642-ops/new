...
describeSandbox("Sandbox medication reminders contract", () => {
  it("reads active reminders without creating, logging, snoozing, refilling, or cancelling a reminder", async () => {
