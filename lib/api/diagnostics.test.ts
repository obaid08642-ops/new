...
describe("diagnostic booking response guards", () => {
  it("allows only approved booking fields and ignores patient, pricing, reports, and document fields", () => {
    ...
    expect(rows).toEqual([{ id: bookingId, state: "CONFIRMED", scheduledAt: "2026-08-20T10:00:00.000Z", locationType: undefined, scanNameAr: undefined, scanNameEn: undefined, medicalReferralRequired: undefined }]);
  });
