...
function assertTestSeedAllowed() {
    if (process.env.NODE_ENV !== 'test' || process.env.ALLOW_TEST_SEED !== 'true') {
        throw new Error('seed_test is restricted to NODE_ENV=test with ALLOW_TEST_SEED=true');
    }
    if (!MONGO_URL)
...
const doctorData = [
    {
        ...
        academic_degree: enums_1.AcademicDegree.CONSULTANT,
        price_clinic: 300,
        price_online: 200,
        price_home: 500,
        city: 'Riyadh',
    ...
    },
    {
        ...
        academic_degree: enums_1.AcademicDegree.SPECIALIST,
        price_clinic: 250,
        price_online: 150,
        price_home: 400,
        city: 'Jeddah',
    ...
    },
    {
        ...
        academic_degree: enums_1.AcademicDegree.SENIOR_SPECIALIST,
        price_clinic: 200,
        price_online: 100,
        price_home: 350,
        city: 'Dammam',
...
async function seed() {
    ...
    const MedicineModel = mongoose.model('Medicine', medicine_schema_1.MedicineSchema);
    let doctorsCount = 0;
