...
let RewardRepository = class RewardRepository extends mongo_repository_1.MongoRepository {
    constructor(model) {
        super(model);
    }
};
...
exports.RewardRepository = RewardRepository = __decorate([
    ...
    __param(0, (0, mongoose_1.InjectModel)(loyalty_schemas_1.Reward.name)),
