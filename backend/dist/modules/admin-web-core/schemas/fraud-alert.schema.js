...
], FraudAlert.prototype, "entityId", void 0);
__decorate([
    (0, mongoose_1.Prop)({ required: true }),
    __metadata("design:type", String)
], FraudAlert.prototype, "entityName", void 0);
__decorate([
    (0, mongoose_1.Prop)({ type: String, enum: ['doctor', 'pharmacy', 'home_care', 'patient'], required: true }),
    __metadata("design:type", String)
], FraudAlert.prototype, "type", void 0);
__decorate([
    (0, mongoose_1.Prop)({ required: true }),
    __metadata("design:type", String)
], FraudAlert.prototype, "flagReason", void 0);
__decorate([
    (0, mongoose_1.Prop)({ type: String, enum: ['high', 'medium', 'low'], required: true }),
    __metadata("design:type", String)
