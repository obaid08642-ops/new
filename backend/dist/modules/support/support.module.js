...
exports.SupportModule = SupportModule = __decorate([
    (0, common_1.Module)({
        imports: [mongoose_1.MongooseModule.forFeature([
                { name: 'SupportRequest', schema: support_schema_1.SupportRequestSchema },
                { name: 'PatientSettings', schema: support_schema_1.PatientSettingsSchema },
            ])],
        controllers: [support_controller_1.SupportController],
        providers: [support_service_1.SupportService, { provide: 'PatientSettingsRepository', useClass: patientsettings_repository_1.PatientSettingsRepository }, { provide: 'SupportRequestRepository', useClass: supportrequest_repository_1.SupportRequestRepository }],
    })
], SupportModule);
