...
let SupportRequestRepository = class SupportRequestRepository extends mongo_repository_1.MongoRepository {
    constructor(model) {
        super(model);
    }
};
...
exports.SupportRequestRepository = SupportRequestRepository = __decorate([
    ...
    __param(0, (0, mongoose_1.InjectModel)(support_schema_1.SupportRequest.name)),
    __metadata("design:paramtypes", [mongoose_2.Model])
], SupportRequestRepository);
//# sourceMappingURL=supportrequest.repository.js.map