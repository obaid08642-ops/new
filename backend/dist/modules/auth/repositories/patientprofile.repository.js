...
let PatientProfileRepository = class PatientProfileRepository extends mongo_repository_1.MongoRepository {
    constructor(model) {
        super(model);
    }
};
exports.PatientProfileRepository = PatientProfileRepository;
exports.PatientProfileRepository = PatientProfileRepository = __decorate([
    (0, common_1.Injectable)(),
    __param(0, (0, mongoose_1.InjectModel)(patient_profile_schema_1.PatientProfile.name)),
    __metadata("design:paramtypes", [mongoose_2.Model])
], PatientProfileRepository);
//# sourceMappingURL=patientprofile.repository.js.map