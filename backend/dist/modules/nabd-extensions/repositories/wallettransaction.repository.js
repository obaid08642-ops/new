...
let WalletTransactionRepository = class WalletTransactionRepository extends mongo_repository_1.MongoRepository {
    constructor(model) {
        super(model);
    }
};
...
exports.WalletTransactionRepository = WalletTransactionRepository = __decorate([
    ...
    __param(0, (0, mongoose_1.InjectModel)(wallet_schema_1.WalletTransaction.name)),
