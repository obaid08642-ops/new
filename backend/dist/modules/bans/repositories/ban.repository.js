...
let BanRepository = class BanRepository extends mongo_repository_1.MongoRepository {
    constructor(model) {
        super(model);
    }
};
exports.BanRepository = BanRepository;
exports.BanRepository = BanRepository = __decorate([
    (0, common_1.Injectable)(),
    __param(0, (0, mongoose_1.InjectModel)(bans_schema_1.Ban.name)),
    __metadata("design:paramtypes", [mongoose_2.Model])
], BanRepository);
//# sourceMappingURL=ban.repository.js.map