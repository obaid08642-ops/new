...
let FeatureFlagRepository = class FeatureFlagRepository extends mongo_repository_1.MongoRepository {
    constructor(model) {
        super(model);
    }
};
...
exports.FeatureFlagRepository = FeatureFlagRepository = __decorate([
    ...
    __param(0, (0, mongoose_1.InjectModel)(feature_flag_schema_1.FeatureFlag.name)),
    __metadata("design:paramtypes", [mongoose_2.Model])
], FeatureFlagRepository);
//# sourceMappingURL=featureflag.repository.js.map