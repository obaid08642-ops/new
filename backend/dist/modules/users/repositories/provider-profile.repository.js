...
let ProviderProfileRepository = class ProviderProfileRepository extends mongo_repository_1.MongoRepository {
    constructor(model) {
        super(model);
    }
};
exports.ProviderProfileRepository = ProviderProfileRepository;
exports.ProviderProfileRepository = ProviderProfileRepository = __decorate([
    (0, common_1.Injectable)(),
    __param(0, (0, mongoose_1.InjectModel)(provider_profile_schema_1.ProviderProfile.name)),
    __metadata("design:paramtypes", [mongoose_2.Model])
], ProviderProfileRepository);
//# sourceMappingURL=provider-profile.repository.js.map