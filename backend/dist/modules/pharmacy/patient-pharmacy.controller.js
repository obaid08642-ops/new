...
exports.PatientPharmacyController = void 0;
...
let PatientPharmacyController = class PatientPharmacyController {
    constructor(shortageSvc) {
        this.shortageSvc = shortageSvc;
    }
    async lookupFlags(drugName) {
...
__decorate([
    (0, common_1.Get)('shortage-flags/lookup'),
    __param(0, (0, common_1.Query)('drugName')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], PatientPharmacyController.prototype, "lookupFlags", null);
...
//# sourceMappingURL=patient-pharmacy.controller.js.map