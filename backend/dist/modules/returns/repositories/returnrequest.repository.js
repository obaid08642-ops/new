...
let ReturnRequestRepository = class ReturnRequestRepository extends mongo_repository_1.MongoRepository {
    constructor(model) {
        super(model);
    }
};
...
exports.ReturnRequestRepository = ReturnRequestRepository = __decorate([
    ...
    __param(0, (0, mongoose_1.InjectModel)(returns_schema_1.ReturnRequest.name)),
    __metadata("design:paramtypes", [mongoose_2.Model])
], ReturnRequestRepository);
//# sourceMappingURL=returnrequest.repository.js.map