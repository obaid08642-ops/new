...
import { UpdateDto, AddItemDto } from './medical-profile.dto';
...
export class MedicalProfileController {
  ...
  @Patch() update(@CurrentUser() u: any, @Body() b: UpdateDto) { return this.svc.update(u, b); }

  @Post('chronic-diseases') addCd(@CurrentUser() u: any, @Body() b: AddItemDto) { return this.svc.addItem(u, 'chronic_diseases', b); }
  @Delete('chronic-diseases/:id') delCd(@CurrentUser() u: any, @Param('id') id: string) { return this.svc.removeItem(u, 'chronic_diseases', id); }

  @Post('allergies') addAl(@CurrentUser() u: any, @Body() b: AddItemDto) { return this.svc.addItem(u, 'allergies', b); }
  @Delete('allergies/:id') delAl(@CurrentUser() u: any, @Param('id') id: string) { return this.svc.removeItem(u, 'allergies', id); }

  @Post('surgeries') addS(@CurrentUser() u: any, @Body() b: AddItemDto) { return this.svc.addItem(u, 'surgeries', b); }
  @Delete('surgeries/:id') delS(@CurrentUser() u: any, @Param('id') id: string) { return this.svc.removeItem(u, 'surgeries', id); }

  @Post('long-term-medications') addLm(@CurrentUser() u: any, @Body() b: AddItemDto) { return this.svc.addItem(u, 'long_term_medications', b); }
