/**
 * Lab catalog seed — populated on backend boot if collection is empty.
 * Contains realistic Saudi-market lab tests + 5 packages.
 */
export const LAB_SEED = [
  ...
  // NOTE: Imaging/Radiology entries were removed from this seed \u2014 they live in /modules/radiology/radiology.seed.ts now.
  // ====== PACKAGES ======
  ...
  { name_ar: 'تحليل فيروس نقص المناعة HIV', name_en: 'HIV Test', short_code: 'HIV', category: 'infection', sample_type: 'blood', price: 120, turnaround_hours: 24, popularity: 70, description_ar: 'كشف الأجسام المضادة لفيروس نقص المناعة البشرية بسرية تامة.', description_en: 'Confidential HIV antibody screening.', preparation_ar: ['لا يتطلب صيام'] },
  { name_ar: 'مسحة عنق الرحم', name_en: 'Pap Smear', short_code: 'PAP', category: 'women', sample_type: 'swab', price: 180, turnaround_hours: 48, popularity: 65, description_ar: 'فحص مبكر لسرطان عنق الرحم.', description_en: 'Cervical cancer screening.', preparation_ar: ['تجنب الفحص أثناء الدورة الشهرية'] },
  { name_ar: 'تحليل السائل المنوي', name_en: 'Semen Analysis', short_code: 'SEMEN', category: 'fertility', sample_type: 'semen', price: 150, turnaround_hours: 24, popularity: 55, description_ar: 'تقييم الخصوبة: العدد والحركة والشكل.', description_en: 'Fertility assessment: count, motility, morphology.', preparation_ar: ['الامتناع 3-5 أيام قبل العينة'] },
  { name_ar: 'اختبار الدرن Quantiferon', name_en: 'Quantiferon-TB', short_code: 'QFT', category: 'infection', sample_type: 'blood', price: 280, turnaround_hours: 48, popularity: 45, description_ar: 'كشف عدوى الدرن الكامنة بدقة أعلى من اختبار الجلد.', description_en: 'Latent TB detection, more accurate than skin test.', preparation_ar: ['لا يتطلب صيام'] },
  { name_ar: 'هرمون البروجسترون', name_en: 'Progesterone', short_code: 'PROG', category: 'hormones', sample_type: 'blood', price: 95, turnaround_hours: 24, popularity: 50, description_ar: 'تقييم التبويض ومتابعة الحمل المبكر.', description_en: 'Ovulation assessment and early pregnancy follow-up.', preparation_ar: ['يُفضل في اليوم 21 من الدورة'] },
  { name_ar: 'الفصل الكهربائي للهيموجلوبين', name_en: 'Hb Electrophoresis', short_code: 'HBE', category: 'blood', sample_type: 'blood', price: 160, turnaround_hours: 48, popularity: 45, description_ar: 'كشف فقر الدم المنجلي والثلاسيميا.', description_en: 'Sickle cell and thalassemia screening.', preparation_ar: ['لا يتطلب صيام'] },
];
