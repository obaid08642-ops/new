  ...
  async parseExcel(fileBuffer: Buffer) {
    try {
      ...
      sheet.eachRow({ includeEmpty: false }, (row, rowNumber) => {
        ...
        if (Object.values(record).some((value) => value !== null && value !== undefined && value !== '')) data.push(record);
      });
