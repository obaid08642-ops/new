...
export class ReturnsService {
   ...
   * exists; otherwise an auditable cash-settlement task. Ledger entries + patient notification
  ...
  async adminDecide(id: string, decision: 'approved' | 'rejected', note: string, adminUser: any) {
    ...
    request.status = exec.method === 'cash_manual_settlement' ? 'approved_pending_cash_refund' : 'completed';
