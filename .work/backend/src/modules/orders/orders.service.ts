...
export class OrdersService {
  ...
  async placeBid(_user: any, _body: { prescription_request_id: string; items: any[]; total_price: number; expires_in_mins?: number }): Promise<never> {
    throw new ServiceUnavailableException('canonical_pharmacy_flow_required');
    /*
  ...
  async acceptBid(_user: any, _bidId: string): Promise<never> {
    throw new ServiceUnavailableException('canonical_pharmacy_flow_required');
    /*
